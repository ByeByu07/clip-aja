...
export function SigninForm({
  ...
  const signInWithSocial = async ({ provider }: { provider: string }) => {
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground text-balance">
                  Login to your Clip Aja account
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button
                onClick={() => signInWithSocial({ provider: "tiktok" })}
                ...
                <Button
                onClick={() => signInWithSocial({ provider: "google" })}
                variant="outline" type="button" className="w-full">
