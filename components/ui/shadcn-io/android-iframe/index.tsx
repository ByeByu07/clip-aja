...
export interface AndroidProps extends SVGProps<SVGSVGElement> {
  ...
  src?: string;
  videoSrc?: string;
  offsetVideoWidth?: number;
  offsetVideoHeight?: number;
}

export const AndroidIframe = ({
  width = 433,
  height = 882,
  offsetVideoWidth = 60,
  offsetVideoHeight = 70,
  src,
  videoSrc,
  ...props
}: AndroidProps) => {
  return (
    ...
    >
      <path
        ...
        className="fill-[#E5E5E5] dark:fill-[#404040] z-10"
      />
      <path
      ...
      <path
        ...
        className="fill-white dark:fill-[#262626] z-10"
      />
      ...
      <g clipPath="url(#android-clip)">
        <path
          ...
          className="fill-[#E5E5E5] stroke-[#E5E5E5] stroke-[0.5] dark:fill-[#404040] dark:stroke-[#404040] z-10"
        />
      </g>
      <circle
        cx="189"
      ...
      {src && (
        <image
          ...
          width="360"
          height="800"
          className="size-full object-cover z-9"
      ...
      {videoSrc && (
        ...
        >
          <iframe
            style={{
              width: width - offsetVideoWidth,
              height: height - offsetVideoHeight,
            }}
            className="z-9"
            src={videoSrc}
          />
